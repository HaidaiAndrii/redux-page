...
export function getId() {
  return fetch("https://front-test.beta.aviasales.ru/search").then(
    (response) => {
...
export function getTickets(id) {
  return fetch(`${SEARCHBYID}${id}`).then((response) => {
...
export function getMovies() {
  return fetch(`http://www.omdbapi.com/?i=tt3896198&apikey=9002146c`).then(
